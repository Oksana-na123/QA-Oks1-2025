...
import org.prog.session11.steps.hw.DataBaseSteps;
...
@CucumberOptions(
        ...
        glue = "org.prog.session11.steps.hw"
)
public class CucumberRunnerHW {
    public class CucumberRunner extends AbstractTestNGCucumberTests {
        ...
        public void beforeSuite() throws ClassNotFoundException, SQLException {
            ...
            DataBaseSteps.connection = DriverManager.getConnection(
        ...
        public void tearDown() throws SQLException {
            ...
            if (DataBaseSteps.connection != null) {
                DataBaseSteps.connection.close();
            }
        }
    }
